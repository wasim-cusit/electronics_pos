...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['edit_customer'])) {
    ...
    $stmt = $pdo->prepare("UPDATE customers SET name=?, contact=?, address=?, email=? WHERE id=?");
                    ...
                    <form method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="contact" class="form-control" value="<?= htmlspecialchars($edit_customer['contact'] ?? '') ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <?php foreach ($customers as $customer): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="customer_history.php?id=<?= $customer['id'] ?>" class="btn btn-sm btn-info">History</a>
